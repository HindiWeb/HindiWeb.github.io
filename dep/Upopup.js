...
.hw-d-box { background-color: white; padding:0;max-width:99%;min-width:50%;  border-radius:5px; border: 1px solid #27a; position:fixed; top:50%;left:50%; transform: translate(-50%,-50%); }
